...
| Setting | Value | Why |
|---|---|---|
| Base viewport | 384 × 216 — **moving to 1280 × 720** with 32px tiles (decided 2026-09-24, see STYLE_GUIDE §0) | 16:9; exactly 2× to 1440p (the user's screen) and 3× to 4K; only 1× on 1080p, see STYLE_GUIDE §0 |
